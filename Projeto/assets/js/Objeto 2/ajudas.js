...
var informacoesTela1 = [
{
  title: 'Informações!',
  html: 'Detalhes da usina - Ver com o Jack'
}
]


var informacoesTela3 = [
{
  title: 'Informações!',
  html: 'Mostrar as fontes como no objeto 1 - Jack? SOMEBODY HELP ME'
}
]


var informacoesTela5 = [
{
  title: 'Informações!',
  html: 'Aqui vai uma animação do Jack'
}
]


function getInfoScene(numeroDaTela) {
  switch(numeroDaTela){
    default:
    return null;
    break;
    case 1:
    return informacoesTela1;
    case 3:
    return informacoesTela3;
    case 5:
    return informacoesTela5;
  }
}

function showInfo(scene) {
  if (getInfoScene(scene)) {
    swal.queue(getInfoScene(scene)).then(function () {
